...
import 'package:zahran/widgets/data_list/congrats_list.dart';
...
class _CongratsScreenState extends State<CongratsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final congData = Provider.of<GetDataProvider>(context, listen: false);
    return Scaffold(
                ...
                Align(
                  ...
                  child: Container(
                      ...
                      child: IconButton(
                          onPressed: () {
                            Navigator.pushNamed(
                                context, AddCongratsScreen.routeName);
                          },
                          icon: const Icon(
                            Icons.add,
                            size: 30,
