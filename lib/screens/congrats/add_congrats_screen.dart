...
class AddCongratsScreen extends StatefulWidget {
  AddCongratsScreen({Key? key}) : super(key: key);
  static const String routeName = '/ Add Congrats Screen';
  bool agreed = false;

  @override
  State<AddCongratsScreen> createState() => _AddCongratsScreenState();
}

class _AddCongratsScreenState extends State<AddCongratsScreen> {
  var _newCong = NewDataModel(
  ...
  Future<void> _saveForm() async {
    ...
    if (isValid! && widget.agreed && fileImage != null) {
      setState(() {
        isLoading = true;
        _newCong = NewDataModel(
            id: _newCong.id,
            title: _newCong.title,
            desc: _newCong.desc,
            img: File(fileImage!.path),
            mobile: _newCong.mobile,
            vedio: File(''),
            device_key: 's');
      });
      ...
      Provider.of<AddDataProvider>(context, listen: false)
          ...
          .then((value) => setState(() {
                ...
                Navigator.pushReplacementNamed(
                    context, OccasionsScreen.routeName,
                    arguments: 'التهنئات');
              }));
    } else {
      return;
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                              label: const Text('عنوان التهنئة'),
