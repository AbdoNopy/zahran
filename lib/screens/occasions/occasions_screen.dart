...
import '../../widgets/data_list/occasions_list.dart';

class OccasionsScreen extends StatelessWidget {
  const OccasionsScreen({Key? key}) : super(key: key);
  static const String routeName = '/Occasions Screen';
                ...
                Align(
                  ...
                  child: Container(
                      ...
                      child: IconButton(
                          onPressed: () {
                            Navigator.pushNamed(
                                context, AddOccScreen.routeName);
                          },
                          icon: const Icon(
                            Icons.add,
                            size: 30,
