...
import '../../widgets/data_list/supporters_list.dart';


class SupportersScreen extends StatefulWidget {
  const SupportersScreen({Key? key}) : super(key: key);
  static const String routeName = '/Supporters Screen';
...
class _SupportersScreenState extends State<SupportersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final supportersData = Provider.of<GetDataProvider>(context, listen: false);
    return Scaffold(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              FutureBuilder(
                future: supportersData.getSupporters(),
