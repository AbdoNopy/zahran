...
class EldersScreen extends StatefulWidget {
  const EldersScreen({Key? key}) : super(key: key);
  static const String routeName = '/Elders Screen';
...
class _EldersScreenState extends State<EldersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final tribsData = Provider.of<GetDataProvider>(context, listen: false);
    return Scaffold(
