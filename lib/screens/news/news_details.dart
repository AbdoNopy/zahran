...
class NewsDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final newsDetail = Provider.of<GetDataProvider>(context).findById(newsId);
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ClipRRect(
                  ...
                  child: Hero(
                      tag: newsDetail.image,
                      child: Image.network(newsDetail.image, fit: BoxFit.fill)),
                ),
              ),
              Container(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${newsDetail.description}${newsDetail.description}${newsDetail.description}${newsDetail.description}${newsDetail.description}',
                        softWrap: true,
                        textDirection: TextDirection.rtl,
                      ),
                    ],
